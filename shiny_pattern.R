...
server <- function(input, output, session) {
 ...
 # In server.R (inside shinyServer function)
  ...
  content = function(file) {
    ...
    blank_line <- ""
    signature <- "§19-24-50-71-26-42-28-76-55-35-54-34-42-56-54-65-20-68-46-23-41-37-72-74-72-59-47-62-70-42-26-76-61-37-21-20-78-69-38-46-55-23-51-53" #standard signature junk line, necessary for the robot. Do not modifiy or remove this. 
